...
class TestGraphFns(unittest.TestCase):
    ...
    #     test.test(api_method=["out1_fsu", "out2_fsu"],
    #               params=dict(in1_fsu=in1_fsu, in2_fsu=in2_fsu),
    ...
    #     out1 = in2
    #     out2 = in1
    #     test.test(api_method=["out1", "out2"],
    #               params=dict(in1=in1, in2=in2),
    ...
    #     out3 = in2
    #     test.test(api_method=["out1", "out2", "out3"],
    #               params=dict(in1=in1, in2=in2),
