...
class BaselinePolicy(Policy):
    def __init__(self, value_weights_spec=None, value_biases_spec=None, value_activation=None,
                 scope="baseline-policy", **kwargs):
        super(BaselinePolicy, self).__init__(scope=scope, **kwargs)
