...
class ComponentTest(object):
    ...
    def test(self, out_socket_name, inputs, expected_outputs):
        ...
        Args:
            ...
            inputs (any): Dict with the in-Socket names as keys and the data (np.arrays, dicts, tuples) as values.
                If not a dict and we only have one in-Socket, a direct value may be given.
        ...
        """
        # We have only one in-Socket and its value is given directly.
