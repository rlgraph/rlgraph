...
class ComponentTest(object):
    ...
    def test(self, out_socket_name, inputs, expected_outputs=None):
        ...
        Args:
            ...
            inputs (dict,np.ndarray): Dict with the in-Socket names as keys and the data (np.arrays, dicts, tuples)
                as values. Alternatively - if there is only one possible in-Socket - can pass in the data directly.
