...
class ImageBinary(PreprocessLayer):
    ...
    def _graph_fn_apply(self, images):
        ...
        Args:
            images (tensor): Single image or a batch of images to be converted into a binary image (last rank=n colors,
        ...
        if get_backend() == "tf":
            ...
            color_channel_sum = tf.reduce_sum(input_tensor=images, axis=-1, keepdims=self.keep_rank)
