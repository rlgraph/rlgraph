...
class Agent(Specifiable):
    ...
    def __init__(self, state_space, action_space,
        ...
        Args:
            ...
            custom_buffers (Optional[Dict[str,Space]]): An optional dict of str + Space pairs used to generate
        ...
        if custom_buffers is not None:
            for key, space in custom_buffers.items():
