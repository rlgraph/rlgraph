...
class TestDistributions(unittest.TestCase):
    ...
    def test_categorical_on_different_space(self):
        ...
        test.test(api_method="sample_deterministic", params=input_, expected_outputs=expected)
        ...
        test.test(api_method="sample_stochastic", params=input_, expected_outputs=expected)
