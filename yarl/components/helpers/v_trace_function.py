...
class VTraceFunction(Component):
    ...
    def _graph_fn_calc_v_trace_values(self, log_rhos, discounts, rewards, values, bootstrap_value,
        ...
        Args:
            ...
            discounts (DataOp): A float32 tensor of shape [T, B] with discounts encountered when
        ...
        Returns:
            DataOpTuple: TODO: documentation
                #- V-Trace value A float32 tensor of shape [T, B]. Can be used as target to
