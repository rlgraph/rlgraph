...
class ComponentTest(object):
    ...
    def test(self, out_socket_name, inputs, expected_outputs=None):
        ...
        Args:
            ...
            inputs (dict): Dict with the in-Socket names as keys and the data (np.arrays, dicts, tuples)
                as values.
        ...
        """
        assert isinstance(inputs, dict), "ERROR: inputs must be a dict of key=in-Socket name, values=data!"
        # Get the outs ..
