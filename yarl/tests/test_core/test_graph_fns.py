...
from yarl.tests.dummy_components import FlattenSplitDummy, NoFlattenNoSplitDummy, OnlyFlattenDummy
...
class TestGraphFns(unittest.TestCase):
    ...
    def test_2_containers_flattening_splitting(self):
        ...
        test = ComponentTest(
            component=component,
            input_spaces=dict(
                in1_fsu=input1_space,
                in2_fsu=input2_space,
            )
        )
        ...
        test.test(out_socket_names=["out1_fsu", "out2_fsu"],
                  inputs=dict(in1_fsu=in1_fsu, in2_fsu=in2_fsu),
    ...
    def test_2_containers_no_options(self):
        ...
        out1 = in2
        out2 = in1
        test.test(out_socket_names=["out1", "out2"],
                  inputs=dict(in1=in1, in2=in2),
    ...
    def test_1_container_1_float_only_flatten(self):
        ...
        out3 = in2
        test.test(out_socket_names=["out1", "out2", "out3"],
                  inputs=dict(in1=in1, in2=in2),
