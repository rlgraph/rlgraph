...
class ComponentTest(object):
    ...
    def test(self, api_methods, expected_outputs=None, decimals=7, fn_test=None):
        """
        ...
        Args:
            api_methods (Union[dict,str]): A dictionary with keys=names of API-methods to call and values=The list of
                ...
                Alternatively: The name (str) of a single API-method to call (w/o parameters).
        ...
        """
        # Get the outs ..
        outs = self.graph_executor.execute(api_methods=api_methods)
