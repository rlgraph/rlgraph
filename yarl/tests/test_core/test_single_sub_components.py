...
class TestSingleSubComponents(unittest.TestCase):
    ...
    # TODO which one of these do we want to rewrite?
    ...
    def test_2to1_component(self):
        ...
        test.test(api_method="output", params=dict(input1=1.0, input2=2.9), expected_outputs=3.9)
        test.test(api_method="output", params=dict(input1=4.9, input2=-0.1),
    ...
    #     test.test(api_method=["output1", "output2"], params=1.0, expected_outputs=[1.0, 2.0])
    #     test.test(api_method=["output1", "output2"], params=4.5, expected_outputs=[4.5, 5.5])
    ...
    #     test.test(api_method="run", params=None, expected_outputs=[8.0])
    ...
    def test_2to1_component_with_constant_input_value(self):
        ...
        test.test(api_method="output", params=dict(input2=4.5), expected_outputs=10.0)
    ...
    #     test.test(api_method="output", params=dict(input1=4.5), expected_outputs=7.5)
