...
class ComponentTest(object):
    ...
    way.
    """
    def __init__(self, test_component, seed=None):
        """
        Args:
            test_component (Component): The Component to test (can contain sub-components).
            seed (Optional[int]): The seed to use for random-seeding the Model object.
        """
        self.seed = seed

        # Create our Model.
        self.model = Model.from_spec(backend(), seed=self.seed)
